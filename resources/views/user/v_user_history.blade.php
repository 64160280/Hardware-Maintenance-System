...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <div class="header_icon"> <i class='bx bxs-user-circle'></i> <span class="mx-2"
                style="color: white; display: flex; align-items: center; margin-left: 10px;">{{ Auth::user()->usrename }}</span>
        </div>
    </header>
    ...
    <div class="d-flex align-items-end border-bottom border-dark w-100" style="height: 150px; padding-bottom: 50px;">
        <h2>ประวัติการแจ้งซ่อม / เบิกอุปกรณ์</h2>

        <div class="d-flex justify-content-end">
            <div class="btn_circle col-sm-6" style="display: flex;">
                <div class="circle1 col-sm-6"
                ...
                <div class="text_c1" style="padding-top: 6px;">
                    <p style="width: 100px; font-size: 15px; margin-left: 10px;">รอรับเรื่อง</p>
                </div>
                <div class="circle1 col-sm-6"
                    style="border-radius: 100%;
                ...
                <div class="text_c2" style="padding-top: 6px;">
                    <p style="width: 100px; font-size: 15px; margin-left: 10px;">ดำเนินการ</p>
                </div>
                <div class="circle1 col-sm-6"
                    style="border-radius: 100%;
                ...
                <div class="text_c3" style="padding-top: 6px;">
                    <p style="width: 100px; font-size: 15px; margin-left: 10px;">ส่งมอบ</p>
                </div>
                <div class="circle1 col-sm-6"
                    style="border-radius: 100%;
                ...
                <div class="text_c4" style="padding-top: 6px;">
                    <p style="width: 60px; font-size: 15px; margin-left: 10px;">เสร็จสิ้น</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex align-items-center w-100 text-center" style="height: 80px;">
        <div class="align-items-center text-center" style="width: 160px;">เลือกประเภทงาน</div>
        ...
        <div class="d-flex justify-content-end">
            <form class="d-flex align-items-center text-center">
                <div class="justify-content-end align-items-center text-center" style="width: 140px;">ค้นหา :</div>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <tr>
                    ...
                    <td>Mark</td>
                    <td>วันที่แจ้ง</td>
                    <td>--ยังไม่มีผู้กำเนินการ--</td>
                    <td>ซ่อมอุปกรณ์</td>
                    <td>เครื่องพิมพ์ Hp</td>
                    <td>รอรับเรื่อง</td>
                </tr>
                <tr>
                    <th scope="row">2</th>
                        ...
                        <div class="card border-white text-center"
                            ...
                            <div class=" mt-auto">
                                <p class="align-bottom mx-auto rounded-0 rounded-pill"
                                    style="border-style: solid; border-width: 2px; width: 250px;">เครื่องพิมพ์ Epson
                                    L3210</p>
                            </div>
                        </div>
