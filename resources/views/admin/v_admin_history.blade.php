...
<body id="body-pd">
    ...
    <div class="height-100 bg-light">
        ...
        <div class="d-flex align-items-end border-bottom border-dark w-100"
            ...
            <h1>ประวัติการแจ้งซ่อมอุปกรณ์ / แจ้งเบิกอุปกรณ์</h1>
        </div>
            ...
            <table class="table table-striped w-100">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Nareson jwbang</td>
                        <td class="justify-content-center text-center">
                            <div>
                                <button type="button" class="btn btn-success rounded-pill"
                                    style="width: 100px; height: 30px; padding-bottom: 25px" data-bs-toggle="modal"
                                    data-bs-target="#succesModal">
                                    <p class="text-white">คะแนน</p>
                                </button>
                            </div>
                        </td>
                    </tr>
