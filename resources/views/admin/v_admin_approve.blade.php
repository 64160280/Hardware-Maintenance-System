...
<body id="body-pd">
    <header class="header" id="header">
        ...
        <div class="header_icon"> <i class='bx bxs-user-circle'></i> <span class="mx-2"
                style="color: white; display: flex; align-items: center; margin-left: 10px;">Admin</span>
        </div>
    </header>
    ...
    <div class="height-100 bg-light">
        ...
        <div class="content w-100">
            {{-- <div class="h" style="display: flex; padding-top: 50px;">
                <div class="text_head "
                    style="width: 700px;
                    text-align:left;
                    margin-left:0;
                    font-size: 42px;">
                    อนุมัติรายการแจ้งซ่อมอุปกรณ์ / แจ้งเบิกอุปกรณ์
            ...
            <div class="d-flex align-items-end border-bottom border-dark w-100"
                ...
                <h1>อนุมัติรายการแจ้งซ่อมอุปกรณ์ / แจ้งเบิกอุปกรณ์</h1>
            </div>
        ...
        <div>
            <table class="table table-striped w-100">
                <thead style="background-color: red; color: white;">
                    <tr>
                        <th scope="col" class="h_t"><input class="form-check-input" type="checkbox"
                    ...
                    @if (!empty($data_approve))
                        @foreach ($data_approve as $data)
                            <tr>
                                ...
                                <th scope="col"><i class='bx bx-dots-vertical-rounded'></i></th>
                                {{-- @php
                                    $date_str = $data['repair_request_date'];
                                @endphp

                                @foreach (explode('-', '/', $date_str) as $new_date)
                                    <td>{{ $new_date }}</td>
                                @endforeach --}}
                                <td> {{ $data['repair_request_date'] }}</td>
                                <td>{{ $data['fname'] }} {{ $data['lname'] }}</td>
                                <td>{{ $data['equipment_name'] }}</td>

                                @php
                                    $change = $data['amount_repair_request'];
                                @endphp

                                @if ($change == 0)
                                    <td>แจ้งซ่อมอุปกรณ์</td>
                                @else
                                    <td>แจ้งเบิกอุปกรณ์</td>
                                @endif
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel" style="margin-left: auto">รายละเอียด</h5>
                        ...
                        <div>
                            <div class="container">
                                <div class="row ">
                                    <div class="col-sm-12 col-md-3 col-lg-3">
                                        <div class="card h-100 border-dark">
                                            ...
                                            <div class="card-body border border-dark border-1 rounded mb-3"
                                                ...
                                                <p class="card-text"><small>ยี่ห้อ/รุ่น : DELL MULTIMEDIA KB216</small>
                                                </p>
                                    ...
                                    <div class="col-sm-12 col-md-3 col-lg-3">
                                        <div class="card h-100 border-dark">
                                            ...
                                            <div class="card-body border border-dark border-1 rounded mb-3"
                                                ...
                                                <p class="card-text"><small>ยี่ห้อ/รุ่น : FUJITSU CH 4ZR1J04218</small>
                                                </p>
                                                <p class="card-text"><small>รายละเอียด</small></p>
                                                <ul>
                                    ...
                                    <div class="col-sm-12 col-md-3 col-lg-3">
                                        <div class="card h-100 border-dark">
                                            <img src="{{ URL::asset('/picture/flash drive.png') }}"
                                                class="card-img-top" style="width:auto; height: 140px;"
                                                alt="...">
                                            <div class="card-body border border-dark border-1 rounded mb-3"
                                                style="width: 95%; margin-left: 6px;">
                        ...
                        <div class="container d-flex align-items-center justify-content-center">
                            <div>
                                ...
                                <span class="d-flex align-items-center justify-content-center"
                                    style="font-size: 34px; font-weight: bold;">ต้องการอนุมัติ</span>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-danger mx-4" data-bs-dismiss="modal">ยกเลิก</button>
                        <button type="submit" class="btn btn-success mx-4">ยืนยัน</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="xModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <form action="">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="container d-flex align-items-center justify-content-center">
                                <div>
                                    <i class='bx bxs-x-circle x-circle'></i>
                                    <br>
